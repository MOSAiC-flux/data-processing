...
def define_level2_variables():
    ...
    lev2_atts['lon_tower_qc']               .update({'comment': 'See global attributes for qc flag definitions.'})
    lev2_atts['heading_tower_qc']           .update({'comment': 'See global attributes for qc flag definitions.'})
    lev2_atts['heading_mast_qc']            .update({'comment': 'See global attributes for qc flag definitions.'})
    lev2_atts['lat_mast_qc']                .update({'comment': 'See global attributes for qc flag definitions.'})
    lev2_atts['lon_mast_qc']                .update({'comment': 'See global attributes for qc flag definitions.'})
    ...
    lev2_atts['temp_2m_qc']                 .update({'comment': 'See global attributes for qc flag definitions.'})
    lev2_atts['temp_6m_qc']                 .update({'comment': 'See global attributes for qc flag definitions.'})
    lev2_atts['temp_10m_qc']                .update({'comment': 'See global attributes for qc flag definitions.'})
    lev2_atts['temp_mast_qc']               .update({'comment': 'See global attributes for qc flag definitions.'})
    lev2_atts['dew_point_2m_qc']            .update({'comment': 'See global attributes for qc flag definitions.'})
    lev2_atts['dew_point_6m_qc']            .update({'comment': 'See global attributes for qc flag definitions.'})
    lev2_atts['dew_point_10m_qc']           .update({'comment': 'See global attributes for qc flag definitions.'})
    lev2_atts['dew_point_mast_qc']          .update({'comment': 'See global attributes for qc flag definitions.'})
    lev2_atts['rh_2m_qc']                   .update({'comment': 'See global attributes for qc flag definitions.'})
    lev2_atts['rh_6m_qc']                   .update({'comment': 'See global attributes for qc flag definitions.'})
    lev2_atts['rh_10m_qc']                  .update({'comment': 'See global attributes for qc flag definitions.'})
    lev2_atts['rh_mast_qc']                 .update({'comment': 'See global attributes for qc flag definitions.'})
    lev2_atts['atmos_pressure_2m_qc']       .update({'comment': 'See global attributes for qc flag definitions.'})
    lev2_atts['atmos_pressure_mast_qc']     .update({'comment': 'See global attributes for qc flag definitions.'})
    ...
    lev2_atts['mixing_ratio_2m_qc']         .update({'comment': 'See global attributes for qc flag definitions.'})
    lev2_atts['mixing_ratio_6m_qc']         .update({'comment': 'See global attributes for qc flag definitions.'})
    lev2_atts['mixing_ratio_10m_qc']        .update({'comment': 'See global attributes for qc flag definitions.'})
    lev2_atts['mixing_ratio_mast_qc']       .update({'comment': 'See global attributes for qc flag definitions.'})
    lev2_atts['rhi_2m_qc']                  .update({'comment': 'See global attributes for qc flag definitions.'})
    lev2_atts['rhi_6m_qc']                  .update({'comment': 'See global attributes for qc flag definitions.'})
    lev2_atts['rhi_10m_qc']                 .update({'comment': 'See global attributes for qc flag definitions.'})
    lev2_atts['rhi_mast_qc']                .update({'comment': 'See global attributes for qc flag definitions.'})
    lev2_atts['vapor_pressure_2m_qc']       .update({'comment': 'See global attributes for qc flag definitions.'})
    lev2_atts['vapor_pressure_6m_qc']       .update({'comment': 'See global attributes for qc flag definitions.'})
    lev2_atts['vapor_pressure_10m_qc']      .update({'comment': 'See global attributes for qc flag definitions.'})
    lev2_atts['vapor_pressure_mast_qc']     .update({'comment': 'See global attributes for qc flag definitions.'})
    lev2_atts['wspd_vec_mean_2m_qc']        .update({'comment': 'See global attributes for qc flag definitions.'})
    lev2_atts['wspd_vec_mean_6m_qc']        .update({'comment': 'See global attributes for qc flag definitions.'})
    lev2_atts['wspd_vec_mean_10m_qc']       .update({'comment': 'See global attributes for qc flag definitions.'})
    lev2_atts['wspd_vec_mean_mast_qc']      .update({'comment': 'See global attributes for qc flag definitions.'})
    lev2_atts['wdir_vec_mean_2m_qc']        .update({'comment': 'See global attributes for qc flag definitions.'})
    lev2_atts['wdir_vec_mean_6m_qc']        .update({'comment': 'See global attributes for qc flag definitions.'})
    lev2_atts['wdir_vec_mean_10m_qc']       .update({'comment': 'See global attributes for qc flag definitions.'})
    lev2_atts['wdir_vec_mean_mast_qc']      .update({'comment': 'See global attributes for qc flag definitions.'})
    ...
    lev2_atts['temp_licor_qc']              .update({'comment': 'See global attributes for qc flag definitions.'})
    lev2_atts['pressure_licor_qc']          .update({'comment': 'See global attributes for qc flag definitions.'})
    lev2_atts['wspd_u_mean_2m_qc']          .update({'comment': 'See global attributes for qc flag definitions.'})
    lev2_atts['wspd_u_mean_6m_qc']          .update({'comment': 'See global attributes for qc flag definitions.'})
    lev2_atts['wspd_u_mean_10m_qc']         .update({'comment': 'See global attributes for qc flag definitions.'})
    lev2_atts['wspd_u_mean_mast_qc']        .update({'comment': 'See global attributes for qc flag definitions.'})
    lev2_atts['wspd_v_mean_2m_qc']          .update({'comment': 'See global attributes for qc flag definitions.'})
    lev2_atts['wspd_v_mean_6m_qc']          .update({'comment': 'See global attributes for qc flag definitions.'})
    lev2_atts['wspd_v_mean_10m_qc']         .update({'comment': 'See global attributes for qc flag definitions.'})
    lev2_atts['wspd_v_mean_mast_qc']        .update({'comment': 'See global attributes for qc flag definitions.'})
    lev2_atts['wspd_w_mean_2m_qc']          .update({'comment': 'See global attributes for qc flag definitions.'})
    lev2_atts['wspd_w_mean_6m_qc']          .update({'comment': 'See global attributes for qc flag definitions.'})
    lev2_atts['wspd_w_mean_10m_qc']         .update({'comment': 'See global attributes for qc flag definitions.'})
    lev2_atts['wspd_w_mean_mast_qc']        .update({'comment': 'See global attributes for qc flag definitions.'})
    lev2_atts['temp_acoustic_mean_2m_qc']   .update({'comment': 'See global attributes for qc flag definitions.'})
    lev2_atts['temp_acoustic_mean_6m_qc']   .update({'comment': 'See global attributes for qc flag definitions.'})
    lev2_atts['temp_acoustic_mean_10m_qc']  .update({'comment': 'See global attributes for qc flag definitions.'})
    lev2_atts['temp_acoustic_mean_mast_qc'] .update({'comment': 'See global attributes for qc flag definitions.'})
    lev2_atts['wspd_u_std_2m_qc']           .update({'comment': 'See global attributes for qc flag definitions.'})
    lev2_atts['wspd_v_std_2m_qc']           .update({'comment': 'See global attributes for qc flag definitions.'})
    lev2_atts['wspd_w_std_2m_qc']           .update({'comment': 'See global attributes for qc flag definitions.'})
    lev2_atts['temp_acoustic_std_2m_qc']    .update({'comment': 'See global attributes for qc flag definitions.'})
    lev2_atts['wspd_u_std_6m_qc']           .update({'comment': 'See global attributes for qc flag definitions.'})
    lev2_atts['wspd_v_std_6m_qc']           .update({'comment': 'See global attributes for qc flag definitions.'})
    lev2_atts['wspd_w_std_6m_qc']           .update({'comment': 'See global attributes for qc flag definitions.'})
    lev2_atts['temp_acoustic_std_6m_qc']    .update({'comment': 'See global attributes for qc flag definitions.'})
    lev2_atts['wspd_u_std_10m_qc']          .update({'comment': 'See global attributes for qc flag definitions.'})
    lev2_atts['wspd_v_std_10m_qc']          .update({'comment': 'See global attributes for qc flag definitions.'})
    lev2_atts['wspd_w_std_10m_qc']          .update({'comment': 'See global attributes for qc flag definitions.'})
    lev2_atts['temp_acoustic_std_10m_qc']   .update({'comment': 'See global attributes for qc flag definitions.'})
    lev2_atts['wspd_u_std_mast_qc']         .update({'comment': 'See global attributes for qc flag definitions.'})
    lev2_atts['wspd_v_std_mast_qc']         .update({'comment': 'See global attributes for qc flag definitions.'})
    lev2_atts['wspd_w_std_mast_qc']         .update({'comment': 'See global attributes for qc flag definitions.'})
    lev2_atts['temp_acoustic_std_mast_qc']  .update({'comment': 'See global attributes for qc flag definitions.'})
